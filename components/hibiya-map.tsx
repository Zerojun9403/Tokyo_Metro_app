...
import { HibiyaStationPanel } from "@/components/hibiya-station-panel";
import {
  HIBIYA_COLOR,
  HIBIYA_STATIONS,
  type HibiyaStation,
...
type HibiyaMapProps = {
  onStationSelect?: (station: HibiyaStation) => void;
};

export function HibiyaMap({ onStationSelect }: HibiyaMapProps) {
  const [selectedStation, setSelectedStation] = useState<HibiyaStation | null>(
    null,
  );

  const handleStationClick = (station: HibiyaStation) => {
    ...
    <>
      <section className="overflow-hidden rounded-[32px] border border-zinc-200 bg-white shadow-[0_8px_30px_rgba(0,0,0,0.04)]">
        ...
        <div className="overflow-x-auto">
          <div className="min-w-[1900px] px-10 py-12">
            <div className="relative">
              ...
              <div
                ...
                style={{
                  gridTemplateColumns: `repeat(${HIBIYA_STATIONS.length}, minmax(76px, 1fr))`,
                }}
              >
                {HIBIYA_STATIONS.map((station) => {
